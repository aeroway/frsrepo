...
<div class="foreigners-border-areas-form">
    ...
    <?= $form->field($model, 'sent_claims_oms')->textInput(['maxlength' => true])->label('Направленные органами местного самоуправления/органами 
        государственной власти иски в судебные органы о понуждении собственника к отчуждению земельного участка') ?>
