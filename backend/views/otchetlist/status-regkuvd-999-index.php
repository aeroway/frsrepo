...
<div class="otchetlist-status-regkuvd-999-index">
    <p>Введите необходимый диапазон дат</p>
    <div class="otchetlist-form-status-regkuvd-999-index">

        <?php $form = ActiveForm::begin(['action' => "/index.php?r=otchetlist/status-regkuvd-999", 'id' => 'status-range-regkuvd-999', 'method' => 'post',]); ?>
