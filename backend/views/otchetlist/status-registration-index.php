...
<div class="otchetlist-status-registration-index">
    <p>Введите необходимый диапазон дат</p>
    <div class="otchetlist-form-status-registration-index">

        <?php $form = ActiveForm::begin(['action' => "/index.php?r=otchetlist/status-registration", 'id' => 'status-range-registration', 'method' => 'post',]); ?>
