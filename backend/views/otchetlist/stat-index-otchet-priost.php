...
<div class="otchetlist-stat-index-otchet-priost">
    <div class="otchetlist-form-stat-otchet-priost">

        <?php $form = ActiveForm::begin([
                'action' => ['otchetlist/stat-index-otchet-priost', 'tblname' => $tblname],
                'id' => 'stat-range-otchet-priost',
                'method' => 'post',
            ]);
        ?>
