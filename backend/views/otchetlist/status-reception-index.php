...
<div class="otchetlist-status-reception-index">
    <p>Введите необходимый диапазон дат</p>
    <div class="otchetlist-form-status-reception-index">

        <?php $form = ActiveForm::begin(['action' => "/index.php?r=otchetlist/status-reception", 'id' => 'status-range-reception', 'method' => 'post',]); ?>
