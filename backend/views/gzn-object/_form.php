...
<div class="gzn-object-form">
    ...
    <div class="row">
        <div class="col-md-6">
            <?= $form->field($model, 'gzn_type_check_id')->widget(Select2::classname(), [
                ...
                'language' => 'ru',
                'options' => ['placeholder' => 'Выберите тип проверки', 'onchange' => 'getSalutationValue(this.value)'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ]);
            ?>
            <?= $form->field($model, 'description_violation')->textInput() ?>
            <?= $form->field($model, 'act_check')->textInput() ?>
            <?= $form->field($model, 'authoritie_check')->dropDownList(
                    ['МВД' => 'МВД', 'МЗК' => 'МЗК', 'КубЗК' => 'КубЗК', 'Прокуратура' => 'Прокуратура', 'ТО' => 'ТО', 'ТО внеплан' => 'ТО внеплан', 'ТО 28.1' => 'ТО 28.1'],
                    ['prompt'=>'Выберите орган проводивший проверку']
            ) ?>
        ...
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'success')->checkbox(); ?>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h4><i class="glyphicon glyphicon-envelope"></i> Нарушения</h4></div>
