...
/**
 * ForeignersAgroSearch represents the model behind the search form of `backend\models\ForeignersAgro`.
 */
class ForeignersAgroSearch extends ForeignersAgro
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['kn', 'address', 'num_reg', 'permit_use', 'date_reg', 'date_term_right', 'fio', 'citizenship', 'notice_ogv_oms', 'notice_prosecutor', 'sent_claims_ogv', 'notice_interior_portal'], 'safe'],
        ];
    }
