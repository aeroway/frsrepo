...
/**
 * InventoryRepairLogSearch represents the model behind the search form of `backend\models\InventoryRepair`.
 */
class InventoryRepairLogSearch extends InventoryRepair
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        // print_r(); die;
        $query = InventoryRepairLog::find()->where(['inventory_repair_id' => $params["id"]]);
