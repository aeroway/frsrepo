...
class EmplEcpSearch extends EmplEcp
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'ecp_org_id', /*'ecp_start', 'ecp_stop',*/ 'nositel_num', 'date_in', 'req_date', 'ecpmodify_date', 'user_in', 'comment_ecp', 'fullName', 'invent_num', 'Statustxt', 'otdels', 'email', 'username'], 'safe'],
        ];
    }
